...
cap program drop ecomplexity_ex
program define ecomplexity_ex
...
local create_variables M RCA RPOP rca rpop mcp density eci pci coi cog kc0 kp0 diversity ubiquity piet_c piet_p coh_c coh_p _merge _fillin id_i id_p
...
foreach y of local year_levels{
		...
		if `calculate_rpop' == 0 & "`cont'"~="" {
			...
			*noi display "	: Continuous"
			...
			calculate_density, knn(`knn') `cont' levels(RPOP)
		}	
		else {
		...
		*===================================
		pietronero 50 /* calculates eigenvector */
		*===================================
		...
		foreach var in M density kc kp kc0 kp0 coi cog piet_c piet_p coh_c coh_p { 
...
cap label var piet_c "Pietronero Country Quality"
cap label var piet_p "Pietronero Product Quality"
cap label var coh_c "Country Coherence"
cap label var coh_p "Product Coherence"
*=====================================================================================
di " "
